...
const Alert = ({ content = 'A simple primary alert—check it out!', theme = 'primary', heading, close, shadow }) => {
   const [show, toggleShow] = useState(true);
   return show && <div className={`${Shadow(shadow)} alert alert-${theme} ${close ? `alert-dismissible fade show` : ''}`} role="alert">
      {heading && <>
